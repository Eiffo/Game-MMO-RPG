...
# Create Black Magic
fire = Spell("Fire", 20, 60, "black")
fireball = Spell("Fireball", 80, 120, "black")
godFire = Spell("GodFire", 350, 800, "black")
...
hyperRestore = Spell("Hyper Restore", 90, 200, "white")

# Create Items
potion = Item("Potion", "potion", "Heals 50 HP", 50)
super_potion = Item("Super Potion", "potion", "Heals 150 HP", 150)
mana_potion = Item("Mana Potion", "potion", "Restore 50 MP", 50)
